...
export default function Home() {
  return (
    <main style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      {/* HERO SECTION */}
      <section className="hero hero-responsive" style={{
        ...
        <div style={{ position: 'absolute', top: '10%', left: '5%', width: 'clamp(200px, 20vw, 300px)', height: 'clamp(200px, 20vw, 300px)', background: 'var(--accent)', opacity: 0.05, borderRadius: '50%', filter: 'blur(80px)' }} />
        <div style={{ position: 'absolute', bottom: '10%', right: '5%', width: 'clamp(250px, 25vw, 400px)', height: 'clamp(250px, 25vw, 400px)', background: 'var(--primary)', opacity: 0.05, borderRadius: '50%', filter: 'blur(100px)' }} />
