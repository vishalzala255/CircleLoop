...
export default function AdminDashboard() {
    ...
    // Realtime sync: auto-refresh when profiles or pickup_requests change
    useEffect(() => {
        if (!user || loading || accessDenied) return;
    ...
    }, [user, loading, accessDenied, fetchData]);
    ...
    if (accessDenied) return (
        <div style={{ 
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ marginBottom: '1rem', color: 'var(--error)' }}>Access Denied</div>
                <div style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}>You don't have permission to access the admin panel.</div>
                <div style={{ marginTop: '2rem', fontSize: '0.85rem', color: 'var(--text-muted)' }}>Redirecting...</div>
            </div>
        </div>
    );
            ...
            <div className="container-max" style={{ padding: '3rem 2rem', flex: 1 }}>
                ...
                <div style={{ marginBottom: '4rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
                        <Link href="/admin/companies" className="btn btn-outline" style={{ 
                            padding: '0.7rem 1.5rem', 
                            fontSize: '0.9rem', 
                            textDecoration: 'none', 
                            borderColor: pathname === '/admin/companies' ? 'var(--accent)' : 'var(--border-color)', 
                            color: pathname === '/admin/companies' ? 'var(--accent)' : 'var(--text-secondary)', 
                            background: pathname === '/admin/companies' ? 'rgba(217, 108, 52, 0.1)' : 'transparent',
                            borderRadius: '50px', 
                            display: 'flex', 
                            alignItems: 'center', 
                            gap: '0.5rem' 
                        ...
                        <Link href="/admin/sales" className="btn btn-outline" style={{ 
                            padding: '0.7rem 1.5rem', 
                            fontSize: '0.9rem', 
                            textDecoration: 'none',
                            borderColor: pathname === '/admin/sales' ? 'var(--primary)' : 'var(--border-color)', 
                            color: pathname === '/admin/sales' ? 'var(--primary)' : 'var(--text-secondary)', 
                            background: pathname === '/admin/sales' ? 'rgba(45, 80, 22, 0.1)' : 'transparent',
                            borderRadius: '50px', 
                            display: 'flex', 
                            alignItems: 'center', 
                            gap: '0.5rem' 
                        ...
                        <Link href="/admin/inventory" className={pathname === '/admin/inventory' ? "btn btn-primary" : "btn btn-outline"} style={{ 
                            padding: '0.7rem 1.5rem', 
                            fontSize: '0.9rem', 
                            textDecoration: 'none', 
                            borderRadius: '50px', 
                        ...
                        <Link href="/admin/messages" className="btn btn-outline" style={{ 
                            padding: '0.7rem 1.5rem', 
                            fontSize: '0.9rem', 
                            textDecoration: 'none', 
                            borderRadius: '50px', 
                            ...
                            alignItems: 'center', 
                            gap: '0.5rem', 
                            borderColor: pathname === '/admin/messages' ? 'var(--primary)' : 'var(--border-color)', 
                            color: pathname === '/admin/messages' ? 'var(--primary)' : 'var(--text-secondary)',
                            background: pathname === '/admin/messages' ? 'rgba(45, 80, 22, 0.1)' : 'transparent'
                        }}>
